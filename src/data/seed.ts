...
/**
 * Seed data for the offline (localStorage) store. On first run this populates
 * the JSON store so the app is immediately usable with realistic history for
 * the dashboard & analytics. The Appwrite backend is seeded by script instead —
 * see `appwrite/README.md`.
 */
...
export const DEFAULT_USERS: StoredUser[] = [
  ...
  },
  {
    ...
    username: "dispatch",
    email: "dispatch@cementplant.com",
  ...
  },
  {
    id: "u-viewer",
    name: "Stock Viewer",
    displayName: "Stock Viewer",
    username: "viewer",
    email: "viewer@cementplant.com",
    password: "viewer123",
    role: "viewer",
    active: true,
    createdAt: "2025-01-01T08:00:00.000Z",
...
export function seedDatabase(): LocalDatabase {
  return {
    version: 2,
    users: DEFAULT_USERS,
    reports: seedReports(),
